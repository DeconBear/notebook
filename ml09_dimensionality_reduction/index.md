...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="../code/ml09_dimensionality_reduction/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="../code/ml09_dimensionality_reduction/exercise.py" target="_blank" download>Download</a> |
