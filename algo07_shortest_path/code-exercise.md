...
<a href="../code/algo07_shortest_path/exercise.py" target="_blank" download>Download exercise.py</a>
...
```bash
cd algo07_shortest_path/code
python exercise.py
```

## 完整代码

<<< @/snippets/algo07_shortest_path/exercise.py
