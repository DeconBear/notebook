...
<a href="../code/algo08_mst_networkflow/exercise.py" target="_blank" download>Download exercise.py</a>
...
```bash
cd algo08_mst_networkflow/code
python exercise.py
```

## 完整代码

<<< @/snippets/algo08_mst_networkflow/exercise.py
