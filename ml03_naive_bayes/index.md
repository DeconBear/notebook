...
- [demo.py 下载](https://github.com/DeconBear/learn-ai/blob/master/ml03_naive_bayes/code/demo.py)
- [exercise.py 下载](https://github.com/DeconBear/learn-ai/blob/master/ml03_naive_bayes/code/exercise.py)
- [代码详解（保姆级教学）](./code-demo)
- [练习指南](./code-exercise)

### 上一章： [ml02 贝叶斯决策理论](../ml02_bayesian_decision/)
### 下一章： [ml04 支持向量机](../ml04_svm/)
