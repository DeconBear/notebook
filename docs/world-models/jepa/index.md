---
title: "wm05 JEPA / V-JEPA"
order: 50
legacyPaths:
  - /wm05_jepa/
---
# wm05 JEPA / V-JEPA：预测表征，而不是预测像素
...
> 没有绝对的优劣：如果你需要"生成一段逼真的视频"，生成式路线是必需的；如果你需要"高效、鲁棒地理解世界的语义结构以支持下游决策"，JEPA 提供了一条更省算力、更抗噪的路径。第七节我们会把包括 JEPA 在内的全部 8 条世界模型路径放在一张表里系统对比。
...
> 下一节 [wm06 Genie：交互式世界模型](/world-models/genie/) 将展示另一条路径——如何从无标签视频中**自动发现"动作"这个概念本身**，构建可交互的生成式世界模型。

## 📥 Code

| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/world-models/jepa/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/world-models/jepa/exercise.py" target="_blank" download>Download</a> |
