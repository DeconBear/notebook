...
<a href="/notebook/code/world-models/genie/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/world-models/genie/code
python demo.py
```
...
<<< @/world-models/genie/code/demo.py
