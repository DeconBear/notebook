...
<a href="/notebook/code/world-models/video/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/world-models/video/code
python demo.py
```
...
<<< @/world-models/video/code/demo.py
