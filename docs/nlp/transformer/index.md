...
> BERT 和 GPT 的详细对比，见 [s17 预训练范式](/nlp/pretrained/)。
...
> 下一节 [s17 预训练范式](/nlp/pretrained/) 将讨论：Transformer 如何催生了大规模预训练——BERT 和 GPT 分别代表了两种训练范式，以及预训练如何彻底改变了 NLP。
...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/nlp/transformer/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/nlp/transformer/exercise.py" target="_blank" download>Download</a> |
| nanogpt.py | [Open](./nanogpt) | <a href="/notebook/code/nlp/transformer/nanogpt.py" target="_blank" download>Download</a> |
