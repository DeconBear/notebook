...
<a href="/notebook/code/systems/deployment/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/systems/deployment/code
python demo.py
```
...
<<< @/systems/deployment/code/demo.py
