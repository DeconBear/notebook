...
<a href="/notebook/code/rl/rlhf/exercise.py" target="_blank" download>Download exercise.py</a>

## 练习目标

通过补全三个 TODO 任务，深入理解 RLHF 的三个核心数学组件：
1. PPO 裁剪替代目标函数 —— 理解"保守更新"的数学原理
2. DPO 损失函数 —— 理解如何绕过奖励模型进行偏好优化
3. GAE 优势估计 —— 理解偏差-方差的折中
