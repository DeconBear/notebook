...
<a href="/notebook/code/algorithms/strategy/divide-conquer/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/algorithms/strategy/divide-conquer/code
python demo.py
```
