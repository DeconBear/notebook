---
title: "algo15 数论与组合数学"
order: 30
legacyPaths:
  - /algo15_number_theory/
---
# algo15 数论与组合数学
...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/topics/number-theory/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/topics/number-theory/exercise.py" target="_blank" download>Download</a> |
