...
<a href="/notebook/code/algorithms/basics/stack-queue/exercise.py" target="_blank" download>Download exercise.py</a>
...
```bash
cd docs/algorithms/basics/stack-queue/code
python exercise.py
```
