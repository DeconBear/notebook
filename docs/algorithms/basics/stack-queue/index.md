...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/basics/stack-queue/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/basics/stack-queue/exercise.py" target="_blank" download>Download</a> |
...
> **上一章**：[数组、链表与哈希表](/algorithms/basics/arrays-hash/)
> **下一章**：[树与二叉树](/algorithms/basics/tree/)
