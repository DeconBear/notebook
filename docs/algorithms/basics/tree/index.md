...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/basics/tree/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/basics/tree/exercise.py" target="_blank" download>Download</a> |
...
> **上一章**：[栈与队列](/algorithms/basics/stack-queue/)
> **下一章**：[堆、并查集与跳跃表](/algorithms/basics/heap-unionfind/)
