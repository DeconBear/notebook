...
<a href="/notebook/code/algorithms/basics/arrays-hash/exercise.py" target="_blank" download>Download exercise.py</a>
...
```bash
cd docs/algorithms/basics/arrays-hash/code
python exercise.py
```
