---
title: "algo02 数组、链表与哈希表"
order: 20
legacyPaths:
  - /algo02_arrays_linkedlist_hash/
---
# 数组、链表与哈希表
...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/basics/arrays-hash/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/basics/arrays-hash/exercise.py" target="_blank" download>Download</a> |
...
> **上一章**：[复杂度分析与渐进记号](/algorithms/basics/complexity/)
> **下一章**：[栈与队列](/algorithms/basics/stack-queue/)
