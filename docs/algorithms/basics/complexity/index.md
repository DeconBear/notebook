...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/basics/complexity/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/basics/complexity/exercise.py" target="_blank" download>Download</a> |
...
> **下一章**：[数组、链表与哈希表](/algorithms/basics/arrays-hash/)
