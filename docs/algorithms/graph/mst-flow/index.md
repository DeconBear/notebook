---
title: "algo08 最小生成树与网络流"
order: 30
legacyPaths:
  - /algo08_mst_networkflow/
---
# 最小生成树与网络流
...
| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/algorithms/graph/mst-flow/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/algorithms/graph/mst-flow/exercise.py" target="_blank" download>Download</a> |
...
> **上一章**：[最短路径](/algorithms/graph/shortest-path/)
> **（全书附录完毕）**
