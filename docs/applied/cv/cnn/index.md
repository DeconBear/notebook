...
> 下一节 [s11 经典架构演进](/applied/cv/architectures/) 将展示这些基本组件如何被组装成 LeNet、AlexNet、VGG、ResNet 等里程碑式的网络架构，以及它们各自的创新点在哪里。量子机器学习里也常用卷积或全连接先压缩图像，再写进线路，见 [量子机器学习](/quantum/qml/)。

## 📥 Code

| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/applied/cv/cnn/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/applied/cv/cnn/exercise.py" target="_blank" download>Download</a> |
