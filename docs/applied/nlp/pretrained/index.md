...
> 下一节 [s18 大语言模型](/applied/nlp/llm/) 将讨论：为什么更大的模型会"涌现"出小模型没有的能力？Scaling Law 告诉我们什么？以及 RLHF 和 DPO 如何让大模型变得可控。

## 📥 Code

| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/applied/nlp/pretrained/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/applied/nlp/pretrained/exercise.py" target="_blank" download>Download</a> |
