...
> 下一节 [s12 目标检测](/cv/object-detection/) 将介绍如何在这些 backbone 上加一个"检测头"，让网络不仅知道"图像里是什么"，还能回答"物体在哪里"。之后的 [s12b Vision Transformer](/cv/vit/) 将展示 Transformer 如何颠覆 CV。

## 📥 Code

| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/cv/architectures/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/cv/architectures/exercise.py" target="_blank" download>Download</a> |
