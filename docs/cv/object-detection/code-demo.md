...
<a href="/notebook/code/cv/object-detection/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/cv/object-detection/code
python demo.py
```
...
<<< @/cv/object-detection/code/demo.py
