...
- [demo.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/advanced/random-forest/code/demo.py)
- [exercise.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/advanced/random-forest/code/exercise.py)
- [代码详解（保姆级教学）](./code-demo)
- [练习指南](./code-exercise)

### 上一章： [ml05 决策树](/ml/classic/decision-tree/)
### 下一章： [ml07 集成学习：Boosting](/ml/advanced/boosting/)
