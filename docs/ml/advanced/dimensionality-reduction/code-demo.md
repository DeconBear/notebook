...
<a href="/notebook/code/ml/advanced/dimensionality-reduction/demo.py" target="_blank" download>Download demo.py</a>

## 运行方式

```bash
cd docs/ml/advanced/dimensionality-reduction/code
python demo.py
```
