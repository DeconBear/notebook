...
- [demo.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/bayesian-decision/code/demo.py) — 完整可运行演示代码
- [exercise.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/bayesian-decision/code/exercise.py) — 动手练习题
- [代码详解（保姆级教学）](./code-demo) — 逐行中文注释和公式推导
- [练习指南](./code-exercise) — 带提示的 TODO 任务

### 上一章： [ml01 k-近邻](/ml/classic/knn/)
### 下一章： [ml03 朴素贝叶斯](/ml/classic/naive-bayes/)
