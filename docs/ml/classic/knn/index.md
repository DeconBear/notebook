...
- [demo.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/knn/code/demo.py) — 完整可运行演示代码
- [exercise.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/knn/code/exercise.py) — 动手练习题
- [代码详解（保姆级教学）](./code-demo) — 逐行中文注释和公式推导
- [练习指南](./code-exercise) — 带提示的 TODO 任务

### 下一章： [ml02 贝叶斯决策理论](/ml/classic/bayesian-decision/)
