...
- [demo.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/decision-tree/code/demo.py)
- [exercise.py 下载](https://github.com/DeconBear/notebook/blob/master/docs/ml/classic/decision-tree/code/exercise.py)
- [代码详解（保姆级教学）](./code-demo)
- [练习指南](./code-exercise)

### 上一章： [ml04 SVM](/ml/classic/svm/)
### 下一章： [ml06 集成学习：Bagging](/ml/advanced/random-forest/)
