...
在 [s08 优化器：从 SGD 到 Adam](/nn-decision/dl/optimizers/) 中，我们知道了 Adam 同时维护一阶矩 $m_t$ 和二阶矩 $v_t$：
...
> 扩展阅读：[混合专家 MoE](/nn-decision/dl/moe/)——用路由与稀疏激活，在相近算力下撑起更大参数量（常替换 Transformer 的 FFN）。

## 📥 Code

| File | View | Download |
|------|------|----------|
| demo.py | [Open](./code-demo) | <a href="/notebook/code/nn-decision/dl/adam/demo.py" target="_blank" download>Download</a> |
| exercise.py | [Open](./code-exercise) | <a href="/notebook/code/nn-decision/dl/adam/exercise.py" target="_blank" download>Download</a> |
